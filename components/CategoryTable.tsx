...
// Plain per-column CSV of whatever's currently filtered/sorted on
// screen — for Transactions specifically, use <TransactionExports />
// instead (the real app-rendered CSV/PDF, with Income/Expenses totals
// and sections), rendered separately above this table. This generic
// export stays for categories that have no dedicated app-side export
// feature of their own (VAT/CIS filters, Expenses, Mileage).
